...
const skills = {
  data: [
    {
      title: "Python Desktop Develop",
      fileName: "DataScienceImg", // FIXME
      skills: [
        "⚡ Comlex desktop apps using most popular GUI frameworks", // FIXME
    ...
    {
      title:
        "GPS monitoring, vehicle telematics and fleet management administration",
      // fileName: "DesignImg",  // FIXME
      skills: [
        "",
        // "⚡ Creating embedded solutions for microcontrollers using Micropython",
      ...
      softwareSkills: [
        {
          skillName: "Wialon",
          fontAwesomeClassname: "simple-icons:globe",
          style: {
            color: "#1488C6",
          },
        },
        {
          skillName: "Fleetrun",
          fontAwesomeClassname: "simple-icons:map-marker",
          style: {
            color: "#1488C6",
          },
        },
